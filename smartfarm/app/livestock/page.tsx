...
import AddEditLivestockDialog from "../../components/livestock/AddEditLivestockDialog";
...
export default function LivestockPage() {
  ...
  async function loadData() {
    setLoading(true);
    try {
      const lData = await dbService.getLivestock();
      setLivestock(lData);
    } catch (e) {
        ...
        <div className="grid gap-6 rounded-[2rem] border border-slate-200/50 dark:border-zinc-800/50 bg-white/80 dark:bg-zinc-950/70 backdrop-blur-xl p-6 shadow-sm">
          ...
          <header className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-sm font-medium text-slate-500 dark:text-zinc-400 mt-1">
                Monitor livestock herds and health checks.
              </p>
            </div>
          ...
          <div className="relative max-w-md">
            ...
            <input
              ...
              placeholder="Search herds or animal type…"
